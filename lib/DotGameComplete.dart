...
import 'package:stroke_rehab_app/DotGame.dart';
...
class DotGameComplete extends StatefulWidget {
  //Got help from this source: https://docs.flutter.dev/cookbook/navigation/passing-data
  String? id;
  String gameType, gameStatus, repetitionNum, startTime, endTime;
  ...
  @override
  _DotGameCompleteState createState() => _DotGameCompleteState();
}

class _DotGameCompleteState extends State<DotGameComplete> {


  String _userName = "";  //Username
  var _repNum = 0; //Repetition number

  var _timeLimit = ""; //time limit
  ...
  getDuration() async {
    final prefer = await SharedPreferences.getInstance();
    _DurationDot = prefer.getInt("DurationDot") ?? 0;
  ...
  getButPress() async {
    final prefer = await SharedPreferences.getInstance();
    _totButPress = prefer.getInt("TotalButtonCount") ?? 0;
  }
  ...
  Widget build(BuildContext context) {
    ...
    var dotgameDatabase = Provider.of<DotDataModel>(context, listen:false).get(widget.id);
    
    return Scaffold(
      appBar: AppBar(
          title: const Text('Dot Game (Goal Mode) Complete'),
              ...
              child: Column(
                children: <Widget>[
                 ...
                 //Got help from these sources:
                  //Flutter - Display Image From File (File.image & ImageFile) Examples: https://www.woolha.com/tutorials/flutter-display-image-from-file-examples
                  //errorBuilder property: https://api.flutter.dev/flutter/widgets/Image/errorBuilder.html
                  Image.file(
                    File(userPicture),
                    width: 250,
                    height: 250,
                            ...
                            if(buttonClick == "Quit"){
                              Fluttertoast.showToast(
                                ...
                                dotgameDatabase = DotData(
                                  ...
                                  repetitionNum: widget.repetitionNum,
                                ...
                                await Provider.of<DotDataModel>(context, listen:false).add(dotgameDatabase!);
                                print('Something happened for firebase!');

                                Navigator.push(context, MaterialPageRoute(
                                    builder:(context) => DotGame()
                                  //builder:(context) => MyNavigationBar() //You have to go to MyNavigationBar instead of main() because MyApp() and MyNavigationBar() is a widget and main() is a void.
                                ));
                            }
